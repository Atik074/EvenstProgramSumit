...
const ActionButton = ({eventId , interestedUserIds ,formDetails}) => {
  ...
  const markGoing =()=>{
    ...
    return (
        ...
        <button onClick={markGoing} className="w-full text-center p-2 bg-[#464849] rounded-md border border-[#5f5f5f]/50 shadow-md cursor-pointer hover:bg-[#3C3D3D] transition-colors active:translate-y-1">Going</button>
      </div>
    );
};
